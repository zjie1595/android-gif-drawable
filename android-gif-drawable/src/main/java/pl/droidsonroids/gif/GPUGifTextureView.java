 ...
 */
public class GPUGifTextureView extends GLTextureView {
    ...
    public GPUGifTextureView(Context context) {
        super(context);
        init(null, 0, 0);
    }

    public GPUGifTextureView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0, 0);
    }
    ...
    private static class RenderThread extends Thread implements SurfaceTextureListener {
        ...
        long[] mSavedState;
        private final WeakReference<GPUGifTextureView> mGifTextureViewReference;

        RenderThread(final GPUGifTextureView gifTextureView) {
        ...
        public void run() {
            try {
                final GPUGifTextureView gifTextureView = mGifTextureViewReference.get();
            ...
            while (!isInterrupted()) {
                ...
                final GPUGifTextureView currentGifTextureView = mGifTextureViewReference.get();
        ...
        void dispose(@NonNull final GPUGifTextureView gifTextureView, @Nullable final GifTextureView.PlaceholderDrawListener drawer) {
            isSurfaceValid.close();
     ...
     */
    public synchronized void setInputSource(@Nullable InputSource inputSource,
                                            @Nullable GifTextureView.PlaceholderDrawListener placeholderDrawListener) {
